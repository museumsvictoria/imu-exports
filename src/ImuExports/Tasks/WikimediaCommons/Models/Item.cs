...
namespace ImuExports.Tasks.WikimediaCommons.Models
{
    public class Item
    {
        ...
        //public List<CommentApiViewModel> Comments { get; set; }
        ...
        public List<string> CollectingAreas { get; set; }
        ...
        public List<string> RelatedSpecimenIds { get; set; }

        public List<string> RelatedArticleIds { get; set; }

        public List<string> RelatedSpeciesIds { get; set; }
        ...
        public List<string> AudioVisualContentSummaries { get; set; }
        ...
        public List<string> TradeLiteraturePublicationTypes { get; set; }

        public string TradeLiteraturePrimaryRole { get; set; }

        public string TradeLiteraturePrimaryName { get; set; }

        public List<string> IndigenousCulturesLocalities { get; set; }

        public List<string> IndigenousCulturesCulturalGroups { get; set; }
